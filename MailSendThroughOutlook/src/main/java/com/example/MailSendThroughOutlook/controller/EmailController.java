...
//    @PostMapping("/send")
//    public ResponseEntity<String> sendCalendarInvites(@RequestBody EmailRequest request) throws Exception {
//        emailService.sendCalendarInvite(request.getRecipients(), request.getEventTitle(), request.getStartTime(), request.getEndTime());
